...
router.post('/', async (req, res) => {
  ...
  try {
    const safetyProtocolText = safetyProtocol ? safetyProtocol.trim() : "Kemasan higienis bersertifikat, terbungkus rapat";
...
router.post('/:id/donate', async (req, res) => {
  ...
  try {
    ...
    const actualCurrent = newCurrent > Number(donation.target) ? Number(donation.target) : newCurrent;
